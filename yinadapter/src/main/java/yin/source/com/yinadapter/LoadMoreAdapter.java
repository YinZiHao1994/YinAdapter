...
public class LoadMoreAdapter<T> extends RecyclerView.Adapter<CommonViewHolder> {
    ...
    public LoadMoreAdapter(CommonAdapter<T> commonAdapter, int loadMoreLayoutRes) {
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (adapter instanceof LoadMoreAdapter) {
                        ...
                        int status = loadMoreAdapter.getStatus();
                        if (status == STATUS_NO_MORE) {
                            haveMore = false;
                        }
                    }
